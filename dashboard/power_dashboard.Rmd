...
#   fillCol(flex = c(NA, 1),
#           inputPanel(
#             setSliderColor(color = c("#55C667FF", "#39558CFF"), sliderId = c(1, 2, 3)),
#             
#             sliderInput("mu0", label = withMathJax('$$\\text{Null mean } \\mu_0 \\text{:}$$'),
#                         min = -2, max = 0, value = 0, step = 0.1),
#             
#             numericInput("n", label = withMathJax('$$\\text{Sample size } n \\text{:}$$'),
#                          min = 3, value = 10, step = 1),
#             
#             sliderInput("alpha", label = withMathJax('$$\\text{Type I error probability } \\alpha \\text{:}$$'),
...
sliderInput("mu1", label = withMathJax('$$\\text{Alternative mean } \\mu_1 \\text{:}$$'),
...
```{r h0.params2}
sliderInput("mu02", label = withMathJax('$$\\text{Null mean } \\mu_0 \\text{:}$$'),
            min = -2, max = 0, value = 0, step = 0.1)



sliderInput("alpha2", label = withMathJax('$$\\text{Type I error probability } \\alpha \\text{:}$$'),
            min = 0, max = 1, value = 0.05)
...
#setSliderColor(color = c("#55C667FF", "#39558CFF"), sliderId = c(1, 2))

sliderInput("mu12", label = withMathJax('$$\\text{Alternative mean } \\mu_1 \\text{:}$$'),
            min = 0, max = 2, value = 1, step = 0.1)

sliderInput("sigma22", label = withMathJax('$$\\text{Variance } \\sigma^2 \\text{:}$$'),
             min = 0, max = 10, value = 1, step = 0.1)
